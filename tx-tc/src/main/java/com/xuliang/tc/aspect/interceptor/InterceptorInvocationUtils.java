...
//import com.xuliang.tc.enums.TransactionPropagation;
...
//            transactionPropagation = TransactionPropagation.parser(transactionAttributes.getProperty(Transactions.DTX_PROPAGATION));
//        } else {
...
//                transactionPropagation = lcnTransaction.propagation();
//            } else {
//
...
//        dtxInfo.setTransactionPropagation(transactionPropagation);
//        return dtxInfo;
//    }
//
//
