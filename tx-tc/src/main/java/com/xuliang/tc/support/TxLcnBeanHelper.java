package com.xuliang.tc.support;
...
public class TxLcnBeanHelper {
     ...
     * 获取分布式事务控制器
     */
    public LCNLocalControl loadDTXLocalControl(String transactionType, DTXPropagationState lcnTransactionState) {
    ...
    private LCNLocalControl loadDTXLocalControl(String beanName) {
        return spring.getBean(beanName, LCNLocalControl.class);
    }
