 ...
 */
package com.xuliang.lcn.support.restapi;

import com.xuliang.lcn.cluster.TMProperties;
import com.xuliang.lcn.core.storage.FastStorage;
import com.xuliang.lcn.service.AdminService;
import com.xuliang.lcn.support.restapi.vo.*;
...
//
    @PostMapping("/login")
    public Token login(@RequestParam("password") String password) throws Exception {
...
//            @RequestParam("unitId") String unitId) throws Exception {
//        try {
...
//    }
    ...
    public TxLogList txLogList(
            ...
            @RequestParam(value = "timeOrder", required = false) Integer timeOrder) throws Exception {
     ...
     */
    @DeleteMapping("/logs")
    public boolean deleteLogs(@RequestBody DeleteLogsReq deleteLogsReq) throws Exception {
...
//    }
    ...
    public List<TMProperties> tmList() throws Exception {
