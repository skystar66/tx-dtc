...
public class MysqlLoggerHelper implements TxLcnLogDbHelper {
    ...
    public int insert(TxLog txLoggerInfo) {
        if (logDbProperties.isEnabled()) {
            ...
            throw new NotEnableLogException("not enable com.xuliang.logger");
        }
    }
